...
gen_true_param = function(K_class = integer(),
  ...
  if (is.null(beta.Z1)) {
    ...
    if (M_state == 3) {
      beta.Z1 = list(
        q12 = c(0.35, -0.65), q13 = c(0.00, 0.00),
        q21 = c(-0.40, -0.30), q23 = c(-0.60, 0.40),
  ...
  if (is.null(beta.Z2)) {
    ...
    if (M_state == 3) {
      beta.Z2 = list(
        ...
        q21 = c(0.24, -0.22), q23 = c(0.35, -0.45),
        q31 = c(0.00, 0.00), q32 = c(0.00, 0.00)
      )
    }
  }
  if (is.null(beta.Z3)) {
    ...
    if (M_state == 3) {
      beta.Z3 = list(
        q12 = c(0.26, 0.26), q13 = c(0.00, 0.00),
        q21 = c(-0.25, 0.30), q23 = c(-0.30, -0.30),
        q31 = c(0.00, 0.00), q32 = c(0.00, 0.00)
      )
    }
  }
